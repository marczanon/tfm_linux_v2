...
modelado base y evaluacion ya estan implementados. El siguiente paso deberia
ser el grafo LangGraph minimo:
...
El grafo debera conectar ejecutores y actualizar el estado con rutas,
